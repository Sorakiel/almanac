...
export const CATALOG: AchievementDef[] = [
  ...
  },
  {
    ...
    tiers: [
      { goal: 20, label: 'I', title: 'Chapter One' },
      { goal: 75, label: 'II', title: 'Chapter Chaser' },
      { goal: 200, label: 'III', title: 'Chapter Marathon' },
      { goal: 600, label: 'IV', title: 'Between the Covers' },
    ],
  },
  {
    id: 'beta',
